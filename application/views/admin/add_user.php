      ...
      <div class="row">
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"> 
          <h2 class="sub-header">Add User</h2>
           ...
           <form method="post" action="<?php echo base_url().'/admin/dashboard/adduser/'.$school_id?>" enctype="multipart/form-data">
              <div class="row">
              <div class="col-md-3">
              <div class="form-group">
                ...
                <label>First Name</label>
                  ...
                  <input type="text"class="form-control border-input" name="username" value="" placeholder="username" disabled>
                  </div>
                  </div>
                </div>
                <div class="row">
