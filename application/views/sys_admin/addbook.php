                        ...
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-tachometer"></i>
                                  <?php echo base_url().'systems/DashBoard'?>">DashBoard</a></li>
                                <li></li>
                            </ul>
                        </div>
                    </div>
...
<div class="modal-body">
         <?php 
          ...
          <?php }?>
          <?php echo form_open_multipart('systems/Dashboard/addbook');?>
              <div class="row">
              <div class="col-md-4">
              ...
              <div class="form-group">
                <label>Book Title</label>
                  ...
                  <label>Book Category</label>
	                   <select class="form-control" name="book_category" id="exampleFormControlSelect1">
					      <option></option>
                  ...
                  <span class="text-danger"><?php echo form_error("book_category"); ?> </span>
                    ...
                    <div class="col-md-4">
                            ...
                            <input type="file" class="form-control border-input" name="book" value="<?php echo set_value('book');?>" placeholder="book">
                     ...
                     <div class="col-md-4">
                            ...
                            <input type="text" class="form-control border-input" name="publisher_id" value="<?php echo set_value('publisher_id');?>" placeholder="publisher Id">
