...
<div class="modal-body">
         <?php 
          ...
          <?php }?>
           <form method="post" action="<?php echo base_url().'/systems/Dashboard/edit_book_details/'.$index['book_isbn']?>" enctype="multipart/form-data">
              <div class="row">
               <div class="col-md-4">
                ...
                <label>Book Title</label>
                  ...
                  <span class="text-danger"><?php echo form_error("book_category"); ?> </span>
                    ...
                    <div class="col-md-4">
                            ...
                            <input type="file" class="form-control border-input" name="book_image" value="<?php echo set_value('book');?>" placeholder="Cover" onchange="readURL(this);">
